...
**81 題完整詳解**（題意 / 解法 / 陷阱 / 可編譯 C++ 完整解）：

| 範圍 | 題數 | 為什麼是這些 |
|---|---|---|
| 一顆星 49 題 | 49 / 49 | 歷屆 14 場逐場比對，**每場恰好 1 題**出自這份名單 |
| 歷屆考古題 | 32 | 已證實會考，價值高於隨機挑二星題 |
| 歷屆 97 題涵蓋率 | 45 (46%) | |

其餘題目（2★ 272 題、3★ 328 題）目前只有題目、連結與難度資料，**沒有詳解**。
這是刻意的：我對那些題沒有可靠掌握，硬寫詳解就是編造，而這份東西是拿來背的。
寧可少寫，也不給錯的。
